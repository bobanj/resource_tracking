...
ActiveRecord::Schema.define(:version => 20101110155559) do
  ...
  create_table "activities", :force => true do |t|
    ...
    t.decimal  "spend_q1",                              :default => 0.0
    t.decimal  "spend_q2",                              :default => 0.0
    t.decimal  "spend_q3",                              :default => 0.0
    t.decimal  "spend_q4",                              :default => 0.0
    t.date     "start"
    t.date     "end"
    ...
    t.decimal  "spend_q4_prev",                         :default => 0.0
    t.integer  "data_response_id"
    t.integer  "activity_id"
    t.decimal  "budget_percentage",                     :default => 0.0
    t.decimal  "spend_percentage",                      :default => 0.0
    t.boolean  "approved"
    ...
    t.decimal  "budget_q1",                             :default => 0.0
    t.decimal  "budget_q2",                             :default => 0.0
    t.decimal  "budget_q3",                             :default => 0.0
    t.decimal  "budget_q4",                             :default => 0.0
    t.decimal  "budget_q4_prev",                        :default => 0.0
  ...
  create_table "projects", :force => true do |t|
    ...
    t.decimal  "budget",           :default => 0.0
    t.decimal  "spend",            :default => 0.0
    t.decimal  "entire_budget",    :default => 0.0
    t.string   "currency"
    t.decimal  "spend_q1",         :default => 0.0
    t.decimal  "spend_q2",         :default => 0.0
    t.decimal  "spend_q3",         :default => 0.0
  ...
  create_table "virtual_code_assignments", :force => true do |t|
    t.integer  "code_id"
